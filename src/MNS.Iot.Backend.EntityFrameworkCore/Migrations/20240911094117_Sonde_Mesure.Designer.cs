...
namespace MNS.Iot.Backend.Migrations
{
    ...
    [Migration("20240911094117_Sonde_Mesure")]
    partial class Sonde_Mesure
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MNS.Iot.Backend.Magasins.Machines.Machine", b =>
                {
                    b.HasOne("MNS.Iot.Backend.Magasins.Passerelles.Passerelle", "Passerelle")
                        .WithMany("Machines")
                        .HasForeignKey("PasserelleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Passerelle");
                });
            ...
            modelBuilder.Entity("MNS.Iot.Backend.Magasins.Sondes.Mesure", b =>
                {
                    b.HasOne("MNS.Iot.Backend.Magasins.Sondes.Sonde", "Sonde")
                        .WithMany("Mesures")
            ...
            modelBuilder.Entity("MNS.Iot.Backend.Magasins.Sondes.Sonde", b =>
                {
                    b.HasOne("MNS.Iot.Backend.Magasins.Machines.Machine", "Machine")
                        .WithMany("Sondes")
